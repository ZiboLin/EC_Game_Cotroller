...
public class Test {
    ...
    public static void main(String[] args) {
		...
		String selfServeralAheadController = "tracks.singlePlayer.self_defined.severalsteplookahead.Agent";
		String selfEvoController = "tracks.singlePlayer.self_defined.evolution.Agent";
		...
		int gameIdx = 13; //0:Aliens 10:boulderchase 13:butterflies 18:chase
		...
		//ArcadeMachine.runOneGame(game, level1, visuals, selfEvoController, recordActionsFile, seed, 0);
// 
		...
		// for(int i=0; i<games.length; i++){
			...
			// ArcadeMachine.runGames(game, new String[]{level1}, M, sampleOneStepController, null);
			 ArcadeMachine.runGames(game, new String[]{level1}, M, selfEvoController, null);
		// }
